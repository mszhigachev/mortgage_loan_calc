...
const PaymentSchedule = (props) => {
    ...
    const calculateNewEarlyMonthPayment = (rate, term, creditLeft) => {
        ...
        return Math.round(creditLeft * monthRate * totalRate / (totalRate - 1) * 100) / 100
    }
    ...
    const rows = () => {
        ...
        for (let i = 1; i < props.creditTerm * 12 + 1; i++) {
            ...
            var earlyCreditBodyPayment = props.isReduceTerm ?earlyMonthPayment - earlyTotalMonthPercent : earlyMonthPayment + earlyPaymentValue - earlyTotalMonthPercent
            if (creditBodyPayment < 0) {
            ...
            var ePaymentValuePrint = props.isReduceTerm ? <EPayment v={earlyPaymentValue} /> : <EPaymentReducePayment reducedPayment={earlyMonthPayment} earlyPaymentValue={earlyPaymentValue} />
            var earlyMonthPaymentPrint = props.isReduceTerm ? <TEPayment v={earlyMonthPayment} /> : <TEPayment v={earlyMonthPayment + earlyPaymentValue} />
            var earlyCreditBodyPaymentPrint = <TEPayment v={earlyCreditBodyPayment} />
            ...
            if (complete || !props.isEarlyPaymentEnabled) {
                ...
                complete = true
                showLastRow = true
                ePaymentValuePrint = props.isReduceTerm ? <EPayment v={earlyPaymentValue} /> : <EPaymentReducePayment reducedPayment={earlyMonthPayment} earlyPaymentValue={earlyLeft + earlyPaymentValue} />
                earlyCreditBodyPaymentPrint = <TEPayment v={earlyCreditBodyPayment + earlyLeft} />
                earlyMonthPaymentPrint = <TEPayment v={earlyMonthPayment + earlyPaymentValue + earlyLeft} />
